...
-- A: 31
SELECT count(*) AS 'total items' FROM albums;
...
SELECT * FROM albums WHERE artist LIKE '%Floyd';

-- The year Sgt. Pepper's Lonely Hearts Club Band was released
-- A: 1967
SELECT artist, name, release_date FROM albums WHERE name LIKE '%Club Band';
